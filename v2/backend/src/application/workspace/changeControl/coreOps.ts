...
function buildConfirmedChangeControl(
  normalized: ReturnType<typeof normalizeIteration>,
  current: ReturnType<typeof defaultIterationChangeControl>,
...
function updateAnalysisReportArtifact(
  repo: WorkspaceRepository,
  iterationId: number,
...
function persistKnowledgeBaseUpdate(
  repo: WorkspaceRepository,
  normalized: ReturnType<typeof normalizeIteration>
) {
...
function publishReadyArtifactMessages(
  repo: WorkspaceRepository,
  iterationId: number,
...
function validateConfirmationPreconditions(
  current: ReturnType<typeof defaultIterationChangeControl>,
  resolution: ReturnType<typeof resolveClarificationSelection>,
  force?: boolean
