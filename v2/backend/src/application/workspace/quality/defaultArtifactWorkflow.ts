  ...
  return {
    ...
    items: [
      ...
      },
      {
        ...
        title: "接口设计",
        category: "API 契约",
        description: "沉淀 RESTful/RPC 接口定义、请求响应结构、错误码与鉴权方式。",
        status: "pending",
        gateStatus: "pending",
        inputVersionRef: 0,
        outputVersion: 0,
        stale: false,
        downstreamImpacts: ["testing", "release", "archive"],
        source: "iteration.apiSpec",
        editCapability: resolveEditCapability("api-specification"),
        summary: "",
        evidence: [],
        draft: { content: "", media: [], updatedAt: "", updatedBy: "" },
        lastConfirmedBy: "",
      ...
      },
      {
        ...
        title: "数据模型设计",
        category: "数据模型",
        description: "沉淀 ER 关系、核心表结构、索引策略与数据迁移方案。",
        status: "pending",
        gateStatus: "pending",
        inputVersionRef: 0,
        outputVersion: 0,
        stale: false,
        downstreamImpacts: ["testing", "release", "archive"],
        source: "iteration.dataModel",
        editCapability: resolveEditCapability("database-design"),
        summary: "",
        evidence: [],
        draft: { content: "", media: [], updatedAt: "", updatedBy: "" },
        lastConfirmedBy: "",
      ...
      },
      {
        ...
        title: "前端代码",
        category: "开发实现",
        description: "沉淀 TypeScript/React 组件、路由、状态管理与 API 调用层。",
        status: "pending",
        gateStatus: "pending",
        inputVersionRef: 0,
        outputVersion: 0,
        stale: false,
        downstreamImpacts: ["testing", "release", "archive"],
        source: "iteration.frontendCode",
        editCapability: resolveEditCapability("frontend-code"),
        summary: "",
        evidence: [],
        draft: { content: "", media: [], updatedAt: "", updatedBy: "" },
        lastConfirmedBy: "",
      ...
      },
      {
        ...
        title: "后端代码",
        category: "开发实现",
        description: "沉淀 API 路由、服务层、数据访问层与中间件。",
        status: "pending",
        gateStatus: "pending",
        inputVersionRef: 0,
        outputVersion: 0,
        stale: false,
        downstreamImpacts: ["testing", "release", "archive"],
        source: "iteration.backendCode",
        editCapability: resolveEditCapability("backend-code"),
        summary: "",
        evidence: [],
        draft: { content: "", media: [], updatedAt: "", updatedBy: "" },
        lastConfirmedBy: "",
      ...
      },
      {
        ...
        title: "部署方案",
        category: "部署运维",
        description: "沉淀环境配置、上线步骤、回滚流程、健康检查与监控告警。",
        status: "pending",
        gateStatus: "pending",
        inputVersionRef: 0,
        outputVersion: 0,
        stale: false,
        downstreamImpacts: ["archive"],
        source: "iteration.deploymentPlan",
        editCapability: resolveEditCapability("deployment-plan"),
        summary: "",
        evidence: [],
        draft: { content: "", media: [], updatedAt: "", updatedBy: "" },
        lastConfirmedBy: "",
