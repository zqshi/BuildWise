...
import type { ProjectPolicyRecord } from '../../../domain/workspace/collaborationTypes';
import { listAuditLogsOp, listGovernancePermissionPointsOp, listGovernanceRolesOp } from './governanceOps';
import { resolveRolePermissions, resolveWorkspaceRole } from './roleResolver';
import {
...
export class GovernanceService {
  ...
  createProjectPolicyDraft(projectId: number, actor: string, strategy?: Partial<ProjectPolicyRecord["strategy"]>) {
  ...
  createGlobalOrchestrationPolicyDraft(actor: string, strategy?: Partial<ProjectPolicyRecord["strategy"]>) {
