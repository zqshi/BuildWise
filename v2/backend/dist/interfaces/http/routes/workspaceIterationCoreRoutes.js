...
exports.registerWorkspaceIterationCoreRoutes = registerWorkspaceIterationCoreRoutes;
...
function registerWorkspaceIterationCoreRoutes(app, service) {
    ...
    app.post("/api/iterations/:id/agent-chat", async (request, reply) => {
        ...
        try {
            ...
            if (error instanceof agentRunner_1.LlmUnavailableError) {
                reply.code(503);
    ...
    app.post("/api/iterations/:id/assessment/restore/:snapshotId", async (request, reply) => {
        const params = request.params;
        const iterationId = (0, workspaceRouteUtils_1.parsePositiveInt)(params.id);
        const snapshotId = (0, workspaceRouteUtils_1.parsePositiveInt)(params.snapshotId);
